...
export const Layout = () => {
  return (
    <div className="flex h-screen">
      <Box p={2.5} className="flex flex-col items-center w-[50px] h-100vh border border-white p-2.5 gap-2.5 border-r border-gray-500 border-solid">
        <Avatar.Root size="xs">
        ...
        <Stack className="flex flex-col overflow-hidden">
          <Tooltip content="总" positioning={{ placement: 'right-end' }}>
            <IconButton aria-label="shop" rounded="full" size="xs" variant="ghost">
              <NavLink to="/">
                <RiAncientGateLine />
              </NavLink>
            </IconButton>
          ...
          <Tooltip content="关于" positioning={{ placement: 'right-end' }}>
            <IconButton aria-label="about" rounded="full" size="xs" variant="ghost">
              <NavLink to="/about">
                <RiSeedlingLine />
              </NavLink>
            </IconButton>
