              ...
              <Collapse defaultActiveKey={['1']} onChange={callback}>
                ...
                <Panel header="自定义长宽高" key="2">
                  <List bordered>
                    <List.Item>
                      <span>长</span>
                      <span><input type="text" value={x} onChange={changeX} /></span>
                    </List.Item>
                    <List.Item>
                      <span>宽</span>
                      <span><input type="text" value={y} onChange={changeY} /></span>
                    </List.Item>
                    <List.Item>
                      <span>高</span>
                      <span><input type="text" value={z} onChange={changeZ}/></span>
                    </List.Item>
                  </List>
                </Panel>
              </Collapse>
