...
const Home = () => (
  <>
    ...
    <div className="container mx-auto">
      ...
      <div className="max-w-screen-lg mx-auto py-10 grid grid-cols-3 gap-20">
          <div className="col-span-1">
            <h3 className="title font-bold text-xl">Recovery</h3>
            <p className="desc">
              At the end of a product's life, some materials can be recovered
              or disposed of to minimize environmental impact.
              <br />
          ...
          <div className="col-span-2" >
              <div className="item">
                ...
                <p>
                  Can be recycled by the majority of households using their
                  curbside program.
                </p>
              </div>
              <div className="item">
              ...
              <div className="item">
                ...
                <p>
                  Breaks down to become part of healthy soil in a home compost
                  pile.
                </p>
              </div>
              <div className="item">
              ...
              <div className="item">
                <h4>Biodegradable </h4>
                <p>
                  Breaks down into elements found in nature when exposed to
      ...
      <div className="max-w-screen-lg mx-auto py-10 grid grid-cols-3 gap-20">
          <div className="col-span-1">
            <div className="item">
              <h3 className="title font-bold text-xl">Materials </h3>
              <p>
                Through sustainably managed sources and reuse, some materials
          ...
          <div className="col-span-2">
            <div className="detail">
              ...
              <div className="item">
                ...
                <p>
                  Contains paper pulp that came from responsibly-managed
                  forests.
                </p>
              </div>
              <div className="item">
              ...
              <div className="item">
                ...
                <p>
                  Made from materials that can regenerate on a human timescale
                  and be responsibly managed.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-1">
            <div className="detail">
              ...
              <div className="item">
                ...
                <p>
                  Uses energy collected from resources that naturally replenish
      ...
      <div className="max-w-screen-lg mx-auto py-10 grid grid-cols-3 gap-20">
          ...
          <div className="col-span-1">
            <div className="item">
              <h3 className="font-bold text-xl">Distribution </h3>
              <p>
