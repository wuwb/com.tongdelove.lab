            ...
            <div className="col-span-5">
              <div className="py-36 px-20">
                ...
                <Link href="/features/collaborate">
                  <a className="block mt-5">有关协作的更多信息→</a>
                </Link>
              </div>
            </div>
            ...
            <Col md={11}>
              <div className="py-36 px-20">
                ...
                <Link href="/features/source">
                  <a className="block mt-5">有关采购的更多信息→</a>
                </Link>
              </div>
            </Col>
          </Row>
            ...
            <Col md={11}>
              <div className="py-36 px-20">
                ...
                <Link href="/features/order">
                  <a className="block mt-5">有关购买的更多信息→</a>
                </Link>
              </div>
            </Col>
            <Col md={13}>
          ...
          <Row justify="center" className="py-10">
            ...
            <Col md={11}>
              <div className="py-36 px-20">
                ...
                <p className="mt-5">
                在开始生产之前，请确保每个细节都是正确的。 我们对打样审批流程进行了标准化，以帮助您避免错误发生。
                </p>
                <Link href="/features/source">
                  <a className="block mt-5">有关打样的更多信息→</a>
                </Link>
              </div>
            </Col>
          </Row>
            ...
            <Col md={11}>
              <div className="p-20">
                ...
                <Link href="/features/produce">
                  <a className="block mt-5">有关生产的更多信息→</a>
                </Link>
              </div>
            </Col>
            <Col md={13}>
          ...
          <Row justify="center" className="py-10">
            ...
            <Col md={11}>
              <div className="py-36 px-20">
                ...
                <p className="mt-5">
                  发现季节性模式，验证战略变更并预测您的需求。 我们的分析功能可帮助您分析包装支出和使用情况。
                </p>
                <Link href="/features/analyze">
                  <a className="block mt-5">有关分析的更多信息→</a>
                </Link>
              </div>
            </Col>
          </Row>
          ...
          <Row justify="center" className="py-10">
            <Col md={11}>
              <div className="py-36 px-20">
                ...
                <p>
                在统一的地方查看产品价格，规格，素材和订单历史记录。
                </p>
                <Link href="/features/produce">
                  <a className="block mt-5">有关数据管理的更多信息→</a>
                </Link>
              </div>
            </Col>
            <Col md={13}>
