(function (b, g) {
  ...
  h('moxie/core/utils/Basic', [], function () {
    ...
    var j = function (v) {
      ...
      return String.prototype.trim
        ? String.prototype.trim.call(v)
        : v.toString().replace(/^\s*/, '').replace(/\s*$/, '');
    };
    var k = function (v) {
      if (typeof v !== 'string') {
        return v;
      }
      var x = { t: 1099511627776, g: 1073741824, m: 1048576, k: 1024 },
        w;
  ...
  h('moxie/core/utils/Env', ['moxie/core/utils/Basic'], function (m) {
    var k = (function (r) {
      ...
      var D = {
        rgx: function () {
          for (var S, M = 0, L, K, J, I, N, O, P = arguments; M < P.length; M += 2) {
            var R = P[M],
              Q = P[M + 1];
            if (typeof S === t) {
              S = {};
                    ...
                    if (I.length == 2) {
                      ...
                      if (I.length == 3) {
                        if (typeof I[1] === B && !(I[1].exec && I[1].test)) {
                          S[I[0]] = O ? I[1].call(this, O, I[2]) : r;
                        } else {
                          S[I[0]] = O ? O.replace(I[1], I[2]) : r;
                        }
                      } else {
                        if (I.length == 4) {
                          S[I[0]] = O ? I[3].call(this, O.replace(I[1], I[2])) : r;
                        }
                      }
                    }
                  } else {
      ...
      var x = {
        browser: [
          ...
          [s, [q, D.str, z.browser.oldsafari.major], [E, D.str, z.browser.oldsafari.version]],
    ...
    function j(v, t, o) {
      var s = 0,
        u = 0,
        n = 0,
        p = { dev: -6, alpha: -5, a: -5, beta: -4, b: -4, RC: -3, rc: -3, '#': -2, p: 1, pl: 1 },
        q = function (w) {
          w = ('' + w).replace(/[_\-+]/g, '.');
  ...
  h('moxie/core/utils/Dom', ['moxie/core/utils/Env'], function (j) {
    ...
    var o = function (r, v) {
      ...
      if (
        ...
        j.browser === 'IE' &&
        (!z.documentMode || z.documentMode < 8)
      ) {
        s = q(r);
        t = q(v);
  ...
  h(
    ...
    ['moxie/core/utils/Basic', 'moxie/core/utils/Dom', 'moxie/core/EventTarget'],
    function (m, l, n) {
      var i = {},
        j = {};
  ...
  h(
    ...
    ['moxie/core/Exceptions', 'moxie/core/utils/Basic', 'moxie/runtime/Runtime'],
    function (i, l, k) {
      return function j() {
        var m;
        l.extend(this, {
    ...
    function (l, j, k) {
      ...
      function m(p, o) {
        ...
        l.extend(this, {
          ...
          detach: function (r) {
            if (this.ruid) {
              this.getRuntime().exec.call(this, 'Blob', 'destroy', i[this.uid]);
  ...
  h(
    ...
    function (q, r, p, y, u, o, s, n, w, z, i, t) {
      var j = {
        100: 'Continue',
      ...
      function v() {
        ...
        q.extend(this, E, {
          uid: q.guid('uid_'),
          upload: new m(),
          open: function (ag, ae, af, ac, ad) {
            var ab;
            if (!ag || !ae) {
              throw new r.DOMException(r.DOMException.SYNTAX_ERR);
            }
            if (/[\u0100-\uffff]/.test(ag) || y.utf8_encode(ag) !== ag) {
              throw new r.DOMException(r.DOMException.SYNTAX_ERR);
            }
            if (
              !!~q.inArray(ag.toUpperCase(), [
                'CONNECT',
                'DELETE',
                'GET',
                'HEAD',
            ...
            if (!!~q.inArray(P, ['CONNECT', 'TRACE', 'TRACK'])) {
              throw new r.DOMException(r.DOMException.SECURITY_ERR);
            }
            ae = y.utf8_encode(ae);
            ab = u.parseUrl(ae);
            H = u.hasSameOrigin(ab);
            J = u.resolveUrl(ae);
            if ((ac || ad) && !H) {
            ...
            G = ad || ab.pass;
            X = af || true;
            if (X === false && (Z('timeout') || Z('withCredentials') || Z('responseType') !== '')) {
              throw new r.DOMException(r.DOMException.INVALID_ACCESS_ERR);
            }
            aa = !X;
            B = false;
          ...
          setRequestHeader: function (ad, ac) {
            ...
            if (Z('readyState') !== v.OPENED || B) {
              throw new r.DOMException(r.DOMException.INVALID_STATE_ERR);
            }
            if (/[\u0100-\uffff]/.test(ad) || y.utf8_encode(ad) !== ad) {
              throw new r.DOMException(r.DOMException.SYNTAX_ERR);
            }
            ad = q.trim(ad).toLowerCase();
            if (!!~q.inArray(ad, ab) || /^(proxy\-|sec\-)/.test(ad)) {
              return false;
            }
            if (!Q[ad]) {
              Q[ad] = ac;
          ...
          getResponseHeader: function (ab) {
            ab = ab.toLowerCase();
            if (D || !!~q.inArray(ab, ['set-cookie', 'set-cookie2'])) {
              return null;
            }
            if (U && U !== '') {
              if (!C) {
                ...
                q.each(U.split(/\r\n/), function (ac) {
                  ...
                  if (ad.length === 2) {
                    ad[0] = q.trim(ad[0]);
                    C[ad[0].toLowerCase()] = { header: ad[0], value: q.trim(ad[1]) };
                  }
                });
              }
              if (C.hasOwnProperty(ab)) {
                return C[ab].header + ': ' + C[ab].value;
              }
            }
            return null;
          },
          overrideMimeType: function (ac) {
            var ab, ad;
            if (!!~q.inArray(Z('readyState'), [v.LOADING, v.DONE])) {
              throw new r.DOMException(r.DOMException.INVALID_STATE_ERR);
            }
            ac = q.trim(ac.toLowerCase());
            if (/;/.test(ac) && (ab = ac.match(/^([^;]+)(?:;\scharset\=)?(.*)$/))) {
              ac = ab[1];
              if (ab[2]) {
                ad = ab[2];
              }
          ...
          send: function (ad, ac) {
            ...
            if (ad instanceof n) {
              T.ruid = ad.ruid;
              K = ad.type || 'application/octet-stream';
            } else {
              if (ad instanceof z) {
                if (ad.hasBlob()) {
                  var ab = ad.getBlob();
                  T.ruid = ab.ruid;
                  K = ab.type || 'application/octet-stream';
                }
              } else {
                if (typeof ad === 'string') {
                  I = 'UTF-8';
            ...
            if (!this.withCredentials) {
              this.withCredentials = T.required_caps && T.required_caps.send_browser_cookies && !H;
            }
            x = !aa && this.upload.hasEventListener();
            D = false;
            L = !ad;
            if (!aa) {
              B = true;
          ...
          abort: function () {
            D = true;
            aa = false;
            if (!~q.inArray(Z('readyState'), [v.UNSENT, v.OPENED, v.DONE])) {
              Z('readyState', v.DONE);
              B = false;
              if (O) {
                O.getRuntime().exec.call(O, 'XMLHttpRequest', 'abort', L);
              } else {
                throw new r.DOMException(r.DOMException.INVALID_STATE_ERR);
              }
              L = true;
            } else {
              Z('readyState', v.UNSENT);
            }
          },
          destroy: function () {
            if (O) {
              if (q.typeOf(O.destroy) === 'function') {
                O.destroy();
              }
              O = null;
            }
        ...
        function Z(ac, ab) {
          ...
          if (arguments.length === 1) {
            return i.can('define_property') ? E[ac] : R[ac];
          } else {
        ...
        function F(ae) {
          ...
          function ad() {
            O.destroy();
            O = null;
            ac.dispatchEvent('loadend');
            ac = null;
          }
          function ab(af) {
            O.bind('LoadStart', function (ag) {
              Z('readyState', v.LOADING);
              ac.dispatchEvent('readystatechange');
              ac.dispatchEvent(ag);
              if (x) {
                ac.upload.dispatchEvent(ag);
              }
            });
            O.bind('Progress', function (ag) {
              if (Z('readyState') !== v.LOADING) {
                Z('readyState', v.LOADING);
                ac.dispatchEvent('readystatechange');
              }
              ac.dispatchEvent(ag);
            });
            O.bind('UploadProgress', function (ag) {
              if (x) {
                ac.upload.dispatchEvent({
                  type: 'progress',
            ...
            O.bind('Load', function (ag) {
              Z('readyState', v.DONE);
              Z('status', Number(af.exec.call(O, 'XMLHttpRequest', 'getStatus') || 0));
              Z('statusText', j[Z('status')] || '');
              Z('response', af.exec.call(O, 'XMLHttpRequest', 'getResponse', Z('responseType')));
              if (!!~q.inArray(Z('responseType'), ['text', ''])) {
                Z('responseText', Z('response'));
              } else {
                if (Z('responseType') === 'document') {
                  Z('responseXML', Z('response'));
                }
              }
              U = af.exec.call(O, 'XMLHttpRequest', 'getAllResponseHeaders');
              ac.dispatchEvent('readystatechange');
              if (Z('status') > 0) {
                if (x) {
                  ac.upload.dispatchEvent(ag);
                ...
                D = true;
                ac.dispatchEvent('error');
              }
              ad();
            });
            O.bind('Abort', function (ag) {
              ac.dispatchEvent(ag);
              ad();
            });
            O.bind('Error', function (ag) {
              D = true;
              Z('readyState', v.DONE);
              ac.dispatchEvent('readystatechange');
              L = true;
            ...
            af.exec.call(
              ...
              'send',
              {
                ...
                mimeType: K,
                encoding: I,
                responseType: ac.responseType,
                withCredentials: ac.withCredentials,
                options: T,
              },
              ae,
            );
          }
          if (typeof T.required_caps === 'string') {
            T.required_caps = o.parseCaps(T.required_caps);
          }
          T.required_caps = q.extend({}, T.required_caps, {
            return_response_type: ac.responseType,
          });
          if (ae instanceof z) {
            T.required_caps.send_multipart = true;
          }
          if (!H) {
            T.required_caps.do_cors = true;
          }
          if (T.ruid) {
            ab(O.connectRuntime(T));
          } else {
            O.bind('RuntimeInit', function (ag, af) {
              ab(af);
            });
            O.bind('RuntimeError', function (ag, af) {
              ac.dispatchEvent('RuntimeError', af);
            });
            O.connectRuntime(T);
          }
        }
  ...
  h(
    ...
    function (k, n, t, r, u, j, s, m, q, w, l, p, o) {
      ...
      function i() {
        ...
        k.extend(this, {
          ...
          downsize: function (G, C, F, D) {
            try {
              ...
              if ((!G && !C) || k.typeOf(F) === 'undefined') {
                F = false;
              }
              G = G || this.width;
              C = C || this.height;
              D = k.typeOf(D) === 'undefined' ? true : !!D;
              this.getRuntime().exec.call(this, 'Image', 'downsize', G, C, F, D);
            } catch (E) {
          ...
          embed: function (F) {
            ...
            function D() {
              ...
              var R = K.getAsDataURL(J, L);
              if (!R) {
                throw new t.ImageError(t.ImageError.WRONG_FORMAT);
              }
              if (q.can('use_data_uri_of', R.length)) {
                F.innerHTML =
                  '<img src="' + R + '" width="' + K.width + '" height="' + K.height + '" />';
                K.destroy();
                N.trigger('embedded');
              } else {
                var Q = new m();
                Q.bind('TransportingComplete', function () {
                  G = N.connectRuntime(this.result.ruid);
                  N.bind(
                    'Embedded',
                    function () {
                  ...
                  G.exec.call(N, 'ImageView', 'display', this.result.uid, E, M);
                  K.destroy();
                });
                Q.transport(
                  o.atob(R.substring(R.indexOf('base64,') + 7)),
                  J,
                  k.extend({}, O, {
            ...
            try {
              ...
              J = O.type || this.type || 'image/jpeg';
              L = O.quality || 90;
              H = k.typeOf(O.crop) !== 'undefined' ? O.crop : false;
              if (O.width) {
                E = O.width;
                M = O.height || E;
              } else {
        ...
        function A(E, F) {
          ...
          if (E.isDetached()) {
            ...
            this.connectRuntime(
              k.extend({ required_caps: { access_image_binary: true, resize_image: true } }, F),
            );
          } else {
        ...
        var r = n.extend(
          {
            ...
            drag_and_drop: t(
              (function () {
                ...
                return (
                  ...
                  (j.browser !== 'IE' || j.version > 9)
                );
              })(),
            ),
            filter_by_extension: t(
              (function () {
                return (
                  (j.browser === 'Chrome' && j.version >= 28) ||
                  (j.browser === 'IE' && j.version >= 10)
                );
              })(),
            ),
            ...
            select_multiple: function () {
              return (
                p.can('select_file') &&
                !(j.browser === 'Safari' && j.os === 'Windows') &&
                !(j.os === 'iOS' && j.verComp(j.osVersion, '7.0.4', '<'))
              );
            },
            send_binary_string: t(
            ...
            summon_file_dialog: t(
              (function () {
                return (
                  (j.browser === 'Firefox' && j.version >= 4) ||
                  (j.browser === 'Opera' && j.version >= 12) ||
                  (j.browser === 'IE' && j.version >= 10) ||
                  !!~n.inArray(j.browser, ['Chrome', 'Safari'])
                );
              })(),
            ),
            upload_filesize: s,
        ...
        o.extend(this, {
          init: function (A) {
            ...
            t.innerHTML =
              ...
              (p.multiple && y.can('select_multiple') ? 'multiple' : '') +
              (p.directory && y.can('select_folder') ? 'webkitdirectory directory' : '') +
              (u ? ' accept="' + u.join(',') + '"' : '') +
              ' />';
            x = l.get(y.uid);
            o.extend(x.style, {
            ...
            if (y.can('summon_file_dialog')) {
              ...
              w = parseInt(l.getStyle(z, 'z-index'), 10) || 1;
              z.style.zIndex = w;
              t.style.zIndex = w - 1;
              j.addEvent(
                z,
    ...
    function (l, m, k, i, j) {
      function n() {
        ...
        m.extend(this, {
          init: function (y) {
            ...
            i.addEvent(
              ...
              function (A) {
                ...
                A.stopPropagation();
                p = [];
                if (A.dataTransfer.items && A.dataTransfer.items[0].webkitGetAsEntry) {
                  u(A.dataTransfer.items, function () {
                    x.trigger('drop');
                  });
                } else {
                  m.each(A.dataTransfer.files, function (B) {
                    if (t(B)) {
                      p.push(B);
                    }
                  });
          ...
          destroy: function () {
            i.removeAllEvents(v && k.get(v.container), this.uid);
            p = r = v = null;
          },
        });
        function q(z) {
          ...
          for (var x = 0; x < z.length; x++) {
            [].push.apply(y, z[x].extensions.split(/\s*,\s*/));
          }
          return m.inArray('*', y) === -1 ? y : [];
        }
        function t(x) {
          var y = j.getFileExtension(x.name);
          return !y || !r.length || m.inArray(y, r) !== -1;
        }
        function u(z, y) {
          var x = [];
          m.each(z, function (C) {
            var B = C.webkitGetAsEntry();
            if (B) {
              if (B.isFile) {
                var A = C.getAsFile();
                if (t(A)) {
      ...
      function q() {
              ...
              if (D instanceof r) {
                if (D.hasBlob()) {
                  if (D.getBlob().isDetached()) {
                    ...
                    if (
                      (C || z) &&
                      j.typeOf(D.getBlob().getSource()) === 'blob' &&
                      window.FileReader
                    ) {
                      s.call(F, G, D);
                      return;
        ...
        function t(A) {
          ...
          if (
            ...
            B &&
            !B.documentElement &&
            /[^\/]+\/[^\+]+\+xml/.test(A.getResponseHeader('Content-Type'))
          ) {
          ...
          if (B) {
            if (
              (m.browser === 'IE' && B.parseError !== 0) ||
              !B.documentElement ||
              B.documentElement.tagName === 'parsererror'
            ) {
              return null;
            }
          }
          ...
          B.each(function (G, F) {
            if (G instanceof k) {
              z +=
                ...
                F +
                '"; filename="' +
                unescape(encodeURIComponent(G.name || 'blob')) +
                '"' +
                D +
                'Content-Type: ' +
    ...
    function (o, i, p, k, m, r, q, j, l) {
      function n() {
        ...
        i.extend(this, {
          loadFromBlob: function (L) {
            ...
            if (L.isDetached()) {
              ...
              F.call(this, L.getSource(), function (N) {
                if (J) {
                  w = H(N);
                }
                z.call(K, N);
          ...
          getAsBinaryString: function (K, M) {
            if (!I) {
              if (!w) {
                w = H(C.getAsDataURL(K, M));
              }
              return w;
            }
            if ('image/jpeg' !== K) {
              ...
              try {
                L = A.toDataURL('image/jpeg', M / 100);
              } catch (J) {
        ...
        function z(K) {
          ...
          B.onerror = function () {
            u.call(this);
            J.trigger('error', new p.ImageError(p.ImageError.WRONG_FORMAT));
          };
          B.onload = function () {
            J.trigger('load');
          };
        ...
        function F(L, M) {
          ...
          if (window.FileReader) {
            ...
            J.onerror = function () {
              K.trigger('error', new p.FileException(p.FileException.NOT_READABLE_ERR));
            };
            J.readAsDataURL(L);
          } else {
            return M(L.getAsDataURL());
          }
        }
        function s(K, V, Q, S) {
          var W = this,
          ...
          P = x();
          M = !Q ? Math.min : Math.max;
          N = M(K / P.width, V / P.height);
          if (N > 1 && (!Q || S)) {
            this.trigger('Resize');
            return;
          }
          ...
          U = Math.round(P.width * N);
          L = Math.round(P.height * N);
          if (Q) {
            A.width = K;
            A.height = V;
            if (U > K) {
          ...
          v.call(this, P, A, -T, -R, U, L);
          this.width = A.width;
          this.height = A.height;
          I = true;
          W.trigger('Resize');
        }
        function v(M, N, J, P, L, O) {
          if (l.OS === 'iOS') {
            q.renderTo(M, N, { width: L, height: O, x: J, y: P });
          } else {
            var K = N.getContext('2d');
            K.drawImage(M, J, P, L, O);
          }
        }
        function y(M, J, L) {
          switch (L) {
      ...
      function q(s) {
        ...
        i.call(
          ...
          },
          {
            ...
            return_response_type: function (u) {
              return j.arrayDiff(u, ['', 'text', 'json', 'document'])
                ? 'browser'
                : ['client', 'browser'];
            },
            return_status_code: function (u) {
        ...
        init: function (l) {
          function k(n) {
            ...
            for (var m = 0; m < n.length; m++) {
              o +=
                (o !== '' ? '|' : '') + n[m].title + ' | *.' + n[m].extensions.replace(/,/g, ';*.');
            }
            return o;
          }
      ...
      function j(q) {
        ...
        l.call(this, q, n, {
          ...
          filter_by_extension: s(
            (function () {
              return (
                (k.browser === 'Chrome' && k.version >= 28) ||
                (k.browser === 'IE' && k.version >= 10)
              );
            })(),
          ),
          resize_image: function () {
          ...
          summon_file_dialog: s(
            (function () {
              return (
                (k.browser === 'Firefox' && k.version >= 4) ||
                (k.browser === 'Opera' && k.version >= 12) ||
                !!~o.inArray(k.browser, ['Chrome', 'Safari'])
              );
            })(),
          ),
          upload_filesize: r,
          ...
          init: function (x) {
            ...
            (function () {
              ...
              if (w.can('summon_file_dialog')) {
                ...
                A = parseInt(l.getStyle(y, 'z-index'), 10) || 1;
                y.style.zIndex = A;
                v.style.zIndex = A - 1;
              }
            ...
            function A() {
              ...
              p.addEvent(
                ...
                function () {
                  ...
                  try {
                    H =
                      u.contentWindow.document || u.contentDocument || window.frames[u.id].document;
...
(function () {
  ...
  (function a(e) {
    ...
    for (d in e) {
      f = typeof e[d];
      if (f === 'object' && !~b(d, ['Exceptions', 'Env', 'Mime'])) {
        a(e[d]);
      } else {
        if (f === 'function') {
          c[d] = e[d];
  ...
  c.Env = window.moxie.core.utils.Env;
  c.Mime = window.moxie.core.utils.Mime;
  c.Exceptions = window.moxie.core.Exceptions;
  window.mOxie = c;
  if (!window.o) {
    window.o = c;
  }
