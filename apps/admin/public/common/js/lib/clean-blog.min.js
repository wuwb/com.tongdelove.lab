    ...
    var d = [],
      e = {
                  ...
                  e
                    ? (c.options.preventSubmit && b.preventDefault(),
                      ...
                      a.isFunction(c.options.submitError) &&
                        c.options.submitError(d, b, f.jqBootstrapValidation('collectErrors', !0)))
                    : (d.removeClass('error'),
              ...
              this.each(function () {
                ...
                if (
                  ...
                  void 0 !== b.attr('maxlength') &&
                    ...
                    (void 0 !== b.attr('required') || void 0 !== b.attr('aria-required')) &&
                    ...
                    a.each(c.validatorTypes, function (c, d) {
                      void 0 === p[c] && (p[c] = []),
                        i ||
                          ...
                          (p[c].push(a.extend(!0, { name: f(d.name), message: g }, d.init(b, e))),
                          (i = !0));
                    }),
                    ...
                    'shortcut' === k
                      ...
                      : a.each(c.validatorTypes, function (c, d) {
                          void 0 === p[c] && (p[c] = []),
                            i ||
                              k !== c.toLowerCase() ||
                              (b.data('validation' + e + f(d.name), j[d.name.toLowerCase()]),
                    ...
                    return (
                      a.each(p, function (d, g) {
                        (f ||
                          f.length ||
                          (e && e.includeEmpty) ||
                          (c.validatorTypes[d].blockSubmit && e && e.submitting)) &&
                  ...
                  b.bind(
                    ...
                    function (d, f) {
                      ...
                      e.find('input,textarea,select').each(function (c, d) {
                        var e = k.length;
                        if (
                          (a.each(a(d).triggerHandler('validation.validation', f), function (a, b) {
                            k.push(b);
                          }),
                          k.length > e)
                        )
        ...
        validatorTypes: {
          ...
          match: {
            ...
            validate: function (a, b, c) {
              return (
                (b !== c.element.val() && !c.negative) || (b === c.element.val() && c.negative)
              );
            },
            blockSubmit: !0,
          },
          ...
          maxlength: {
            ...
            validate: function (a, b, c) {
              return (
                (b.length > c.maxlength && !c.negative) || (b.length <= c.maxlength && c.negative)
              );
            },
          },
          minlength: {
            ...
            validate: function (a, b, c) {
              return (
                (b.length < c.minlength && !c.negative) || (b.length >= c.minlength && c.negative)
              );
            },
          },
          maxchecked: {
      ...
      g = function (b) {
        ...
        return (
          ...
          'radio' === d &&
            (c = a('input[name="' + b.attr('name') + '"]:checked').length > 0 ? c : ''),
          c
        );
      };
