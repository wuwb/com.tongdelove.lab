  ...
  if ('undefined' != typeof e) {
    ...
    (t.prototype = t.fn = {
      ...
      init: function (i, o) {
        ...
        var s = (this.classNames = {
          textarea: { html: r + 'html-textarea', markdown: r + 'markdown-textarea' },
        });
        ...
        l.length < 1 &&
          (a.append('<textarea></textarea>'), (l = this.markdownTextarea = a.children('textarea'))),
        ...
        var c = [
          n.readOnly
            ? ''
            : '<a href="javascript:;" class="fa fa-close ' + r + 'preview-close-btn"></a>',
      ...
      setCodeMirror: function () {
        ...
        return (
          ...
          e.autoHeight &&
            (this.codeMirror.css('height', 'auto'), this.cm.setOption('viewportMargin', 1 / 0)),
      ...
      gotoLine: function (t) {
        ...
        var o = this.cm,
          ...
          n = this.preview;
        if (
          ('string' == typeof t && ('last' === t && (t = r), 'first' === t && (t = 1)),
          'number' != typeof t)
        )
        ...
        if ((o.scrollTo(null, (l.top + l.bottom - s) / 2), i.watch)) {
          var c = this.codeMirror.find('.CodeMirror-scroll')[0],
            ...
            u = d / c.scrollHeight;
          n.scrollTop(
            0 === d ? 0 : d + h >= c.scrollHeight - 16 ? n[0].scrollHeight : n[0].scrollHeight * u,
          );
        }
        return o.focus(), this;
      },
      extend: function () {
        return (
          'undefined' != typeof arguments[1] &&
            ('function' == typeof arguments[1] && (arguments[1] = e.proxy(arguments[1], this)),
      ...
      set: function (t, i) {
        return (
          'undefined' != typeof i && 'function' == typeof i && (i = e.proxy(i, this)),
          (this[t] = i),
          this
        );
      },
      ...
      showInfoDialog: function () {
        ...
        return (
          ...
          this.lockScreen(!0),
          this.mask
            .css({ opacity: o.dialogMaskOpacity, backgroundColor: o.dialogMaskBgColor })
            .show(),
      ...
      recreate: function () {
        ...
        return (
          ...
          this.setCodeMirror(),
          t.readOnly ||
            (e.find('.editormd-dialog').length > 0 && e.find('.editormd-dialog').remove(),
      ...
      bindScrollEvent: function () {
        ...
        return (
          ...
          'single' === r.syncScrolling
            ? this
            : (o.bind({ mouseover: c, mouseout: h, touchstart: c, touchend: h }), this)
        );
      },
      bindChangeEvent: function () {
        ...
        return o.syncScrolling
          ? (t.on('change', function (t, r) {
              o.watch &&
                e.previewContainer.css('padding', o.autoHeight ? '20px 20px 50px 40px' : '20px'),
          ...
          !s.autoHeight || o.fullscreen || o.preview
            ? (i && r.css('height', 'number' == typeof i ? i + 'px' : i),
              ...
              s.toolbar && !s.readOnly
                ? l.css('margin-top', a.height() + 1).height(r.height() - a.height())
        ...
        if (
          ...
          if ((c.html(g), this.previewCodeHighlight(), a.toc)) {
            ...
            p.attr('previewContainer', '' === a.tocContainer ? 'true' : 'false'),
              ...
              (a.tocDropdown || p.find('.' + this.classPrefix + 'toc-menu').length > 0) &&
                t.tocDropdownMenu(p, '' !== a.tocTitle ? a.tocTitle : this.lang.tocTitle),
      ...
      (t.toolbarHandlers = {
        ...
        quote: function () {
          var e = this.cm,
            ...
            i = e.getSelection();
          0 !== t.ch
            ? (e.setCursor(t.line, 0), e.replaceSelection('> ' + i), e.setCursor(t.line, t.ch + 2))
        ...
        h2: function () {
          var e = this.cm,
            ...
            i = e.getSelection();
          0 !== t.ch
            ? (e.setCursor(t.line, 0), e.replaceSelection('## ' + i), e.setCursor(t.line, t.ch + 3))
            : e.replaceSelection('## ' + i);
        },
        h3: function () {
          var e = this.cm,
        ...
        datetime: function () {
          var e = this.cm,
            ...
            o =
              t.dateFormat() +
              ' ' +
              t.dateFormat('zh-cn' === i || 'zh-tw' === i ? 'cn-week-day' : 'week-day');
      ...
      (t.keyMaps = {
        ...
        'Ctrl-E': function () {
          ...
          return this.settings.emoji
            ? (e.replaceSelection(':' + i + ':'), void ('' === i && e.setCursor(t.line, t.ch + 1)))
    ...
    return (
                ...
                (e = e.replace(new RegExp(i[o]), function (e, i) {
                  ...
                  if (o)
                    for (var n = 0, a = o.length; a > n; n++) {
                      var s = o[n].replace(/:/g, '');
                      return (
                        '<i class="fa ' + s + ' fa-emoji" title="' + s.replace('fa-', '') + '"></i>'
                      );
                    }
                  else {
                    var l = e.match(m),
              ...
              ? (a.atLink &&
                ...
                a.emailLink &&
                  (i = i.replace(f, function (t, i, o, r, n) {
                    return !i && e.inArray(n, 'jpg|jpeg|png|gif|webp|ico|icon|pdf'.split('|')) < 0
                      ? '<a href="mailto:' + t + '">' + t + '</a>'
                      : t;
                  })),
                i)
            ...
            e =
              !o && i
                ? e.replace(/(\$\$([^\$]*)\$\$)+/g, function (e, i) {
                    return (
                      '<span class="' + t.classNames.tex + '">' + i.replace(/\$/g, '') + '</span>'
                    );
                  })
                : o
                ? e.replace(/\$/g, '')
                    ...
                    l.each(function () {
                      ...
                      if (('' === i.html() && i.remove(), i.length > 0 && '' !== i.html())) {
                        ...
                        r.children('.fa').length < 1 &&
                          r.append(e(n).css({ float: 'right', paddingTop: '4px' }));
                      }
      ...
      (t.markdownToHTML = function (i, o) {
        ...
        if (
          ...
          a.toc &&
            ...
            (a.tocDropdown || n.find('.' + this.classPrefix + 'toc-menu').length > 0) &&
          ...
          t.isIE8 ||
            ...
            a.sequenceDiagram && n.find('.sequence-diagram').sequenceDiagram({ theme: 'simple' })),
          a.tex)
        ) {
          var g = function () {
      ...
      (t.createDialog = function (i) {
        ...
        '' !== i.title &&
          ((h +=
            '<div class="' + a + 'dialog-header"' + (i.drag ? ' style="cursor: move;"' : '') + '>'),
          (h += '<strong class="' + a + 'dialog-title">' + i.title + '</strong>'),
          (h += '</div>')),
          i.closed &&
            (h += '<a href="javascript:;" class="fa fa-close ' + a + 'dialog-close"></a>'),
