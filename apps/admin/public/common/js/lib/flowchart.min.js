...
!(function () {
  ...
  function d(a, b, c, d) {
    ...
    if (
      ...
      var q = 0,
        r = 0;
      m
        ? ((q = b.x > p.x ? b.x - (b.x - p.x) / 2 : p.x - (p.x - b.x) / 2),
          (r = b.y > p.y ? b.y - (b.y - p.y) / 2 : p.y - (p.y - b.y) / 2),
          o
            ? ((q -= n.getBBox().width / 2), (r -= a.options['text-margin']))
            : ((q += a.options['text-margin']), (r -= n.getBBox().height / 2)))
        : ((q = b.x),
          (r = b.y),
          o
            ? ((q += a.options['text-margin'] / 2), (r -= a.options['text-margin']))
            : ((q += a.options['text-margin'] / 2), (r += a.options['text-margin']))),
        n.attr({
          'text-anchor': 'start',
  ...
  function k(a, b) {
    ...
    (b = b || {}),
      g.call(this, a, b, c),
      c.attr({ width: this.text.getBBox().width + 4 * this.getAttr('text-margin') }),
              ...
              return (
                d.start === a
                  ...
                  : b &&
                    f &&
                    !b.pathOk &&
                    (b instanceof m ? (f.yes === a && b.yes(g), f.no === a && b.no(g)) : b.then(g)),
                g.pathOk
                  ? g
                  : (g instanceof m
                      ? (a.yes && n(a.yes, g, a), a.no && n(a.no, g, a))
                      : a.next && n(a.next, g, a),
                    g)
              );
            })(this.start),
      ...
      if (t.indexOf('=>') >= 0) {
        ...
        if (
          (w.symbolType.indexOf(': ') >= 0 &&
            ((u = w.symbolType.split(': ')), (w.symbolType = u[0]), (w.text = u[1])),
          w.text && w.text.indexOf(':>') >= 0
            ? ((u = w.text.split(':>')), (w.text = u[0]), (w.link = u[1]))
            : w.symbolType.indexOf(':>') >= 0 &&
              ((u = w.symbolType.split(':>')), (w.symbolType = u[0]), (w.link = u[1])),
          ...
          x >= 0 &&
            y >= 0 &&
            ((w.target = w.link.substring(x, y)), (w.link = w.link.substring(0, x - 1)));
        }
  ...
  (f.prototype.handle = function (a) {
    ...
    (g.prototype.drawLineTo = function (a, b, c) {
                ...
                if ((c && 'bottom' !== c) || !u)
                  if ((c && 'bottom' !== c) || !v)
                    if (c && 'right' === c && u)
                      ...
                      'left' === c &&
                        ((f = d(
                          ...
                          k,
                          [
                            { x: n.x + (k.x - n.x) / 2, y: k.y },
                            { x: n.x + (k.x - n.x) / 2, y: n.y - x / 2 },
                            { x: n.x, y: n.y - x / 2 },
                            { x: n.x, y: n.y },
                          ],
                          b,
                    ...
                    (f = d(
                      ...
                      [
                        { x: j.x, y: j.y + x / 2 },
                        { x: j.x + (j.x - n.x) / 2, y: j.y + x / 2 },
                        { x: j.x + (j.x - n.x) / 2, y: n.y - x / 2 },
                        { x: n.x, y: n.y - x / 2 },
                        { x: n.x, y: n.y },
                      ],
                      b,
      ...
      if (f) {
        for (var A = 0, B = this.chart.lines.length; B > A; A++)
          for (
            ...
            for (
              var J = I[0][1], K = I[0][2], L = I[1][1], M = I[1][2], N = 0, O = F.length - 1;
              O > N;
              N++
            ) {
              var P = [];
      ...
      (!this.chart.maxXFromLine || (this.chart.maxXFromLine && w > this.chart.maxXFromLine)) &&
      ...
      if (this.bottom_symbol) {
        ...
        this.bottom_symbol.getTop(),
          this.bottom_symbol.isPositioned ||
            (this.bottom_symbol.shiftY(this.getY() + this.height + a),
