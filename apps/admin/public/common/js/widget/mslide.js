...
MSliderH5.prototype = {
  ...
  goPage: function (index) {
    ...
    if (that.opts.turnMode == 'fade') {
      ...
      nextBanner.attr(
        'style',
        'z-index:2;display:block; -webkit-animation: fadeIn ease-in ' + transDuration + 'ms;',
      );
      ...
      setTimeout(function () {
        bannerParent.attr(
          ...
          'z-index:2;-webkit-transform: translate3d(' +
            -left +
            'px,0,0); -webkit-transition: -webkit-transform ease-out ' +
            transDuration +
            'ms;',
        );
      }, 0);
  ...
  loadingImage: function (index) {
    ...
    var style = MoGu.isIos
      ? '-webkit-animation: fadeIn .2s ease both 0s; animation: fadeIn .2s ease both 0s;'
      : '';
    ...
    img.onload = function () {
      ...
      if (banner.hasClass('mslide_banner_show')) {
        banner.append(
          '<img class="mslide_banner_img fill_img" style="' +
            style +
            '" src="' +
            img.src +
            '" alt=""/>',
        ...
        banner.append(
          '<img class="mslide_banner_img fill_img" style="display:block;" src="' +
            img.src +
            '" alt=""/>',
        );
      }
  ...
  addDefaultBtn: function () {
    ...
    // 添加按钮Html
    var turnBtnHtml =
      '<a class="msilde_toggle_btn msilde_prev_btn" href="javascript:;" title="上一张"></a><a class="msilde_toggle_btn msilde_next_btn" href="javascript:;" title="下一张"></a>';
    // 向容器添加切换按钮
