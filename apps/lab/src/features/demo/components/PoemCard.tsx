  ...
  return (
    <div className="max-w-sm overflow-hidden rounded shadow-lg">
      <div className="aspect-h-9 aspect-w-16 lg:aspect-none h-56">
        <img className="h-full w-full object-cover object-center lg:h-full lg:w-full" src={image ?? ''} alt={title} />
      </div>
      ...
      <div className="px-6 pb-2 pt-4">
        {keywords.map(keyword => {
          return (
            <span key={keyword} className="mb-2 mr-2 inline-block rounded-full bg-gray-200 px-3 py-1 text-sm font-semibold text-gray-700">
              #{keyword}
            </span>
          )
        })}
