...
import { type serverRuntimeEnvSchema } from '../configs/server-runtime-env.config.mjs'
 ...
 */
type ProcessEnvKeyForServerEnv = Record<keyof z.infer<typeof serverRuntimeEnvSchema>, string | undefined>
