            ...
            <form>
              ...
              <div className="form-group mb-6">
                ...
                <input
                  name="email"
                  type="text"
                  className={`form-control form-control } m-0 block w-full rounded border border-solid border-gray-300 bg-white bg-clip-padding px-4 py-2 text-xl font-normal text-gray-700 transition ease-in-out focus:border-blue-600 focus:bg-white focus:text-gray-700
                    focus:outline-none`}
                />
                <div className="invalid-feedback"></div>
              </div>
            ...
            <div className="rounded-t-lg p-8">
              ...
              <div>
                <div className="mt-3 flex items-center justify-center space-x-4">
                  <button className="hover: flex transform items-center rounded border border-transparent bg-white px-4 py-2 text-sm font-medium uppercase text-indigo-500 shadow-md transition hover:-translate-y-0.5 hover:border-transparent hover:text-gray-700 hover:shadow-lg">
