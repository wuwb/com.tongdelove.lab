...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@tongdelove/ui/card'
  ...
  return (
    <>
      ...
      <div className="container relative hidden h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        {/* login button */}
        <Link href="/auth/register" className={cn(buttonVariants({ variant: 'ghost', size: 'sm' }), 'absolute right-4 top-4 md:right-8 md:top-8')}>
          Register
        </Link>
        {/* left section */}
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          ...
          />
          <div className="relative z-20 flex items-center text-lg font-medium">Tongdelove Inc</div>
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;This library has saved me countless hours of work and helped me deliver stunning designs to my clients faster than ever before. Highly recommended!&rdquo;
              </p>
