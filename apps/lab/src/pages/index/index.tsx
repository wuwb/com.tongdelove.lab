...
import { Button, Text, Group, Card, Image } from "@chakra-ui/react"
    ...
    <div className="pb-20">
      <div className="flex-center flex-wrap sm:flex-nowrap sm:gap-20 sm:px-48">
        <div className="md:p-15 w-full p-5 sm:w-1/2 sm:p-10 sm:pr-0 lg:p-16">
          <Card.Root >
            <Card.Body href="/sticker" className="p-5 pb-0">
              <Image
        ...
        <div className="md:p-15 -mt-5 w-full p-5 sm:mt-0 sm:w-1/2 sm:p-10 sm:pl-0 lg:p-16">
          <Card.Root shadow="sm" padding="lg" radius="md" withBorder>
            <Card.Body component="a" href="/logo-gen" className="p-5 pb-0">
              <Image
