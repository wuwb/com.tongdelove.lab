          ...
          {(transitionStyles) => (
            <div style={transitionStyles} className="flex flex-col gap-1">
              <Tooltip label={t('QQ 群：96064860')} position="left" withArrow>
                <Link href="http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=TDJPzbUN8r9yjnO_tcuzo48pFpW0r0gW&authKey=XPvEt5MQ1GkNny9hi2pDTeSDETzktu%2FSt8wkPGwGvfbY4X7gIsS%2BgS1mUBu8zRa8&noverify=0&group_code=96064860" target="_blank">
                  <ActionIcon
                    className="group"
                    variant="subtle"
                    color="gray"
              ...
              <Tooltip label={t('微信公众号：DeepDevelop')} position="left" withArrow>
                <ActionIcon
                  className="group"
                  variant="subtle"
                  color="gray"
                ...
                >
                  <RiWechatFill size="22" className="group-hover:text-[#2ecc71]" />
                </ActionIcon>
              </Tooltip>
              <Link href="https://weibo.com/u/1732957967" target="_blank">
                <ActionIcon
                  ...
                  aria-label="Settings"
                >
                  <RiWeiboFill size="22" className="group-hover:text-[#e74c3c]" />
                </ActionIcon>
              </Link>
