  ...
  return (
    <div className="flex flex-row sm:gap-10">
        ...
        <aside className="sidebar sidebar-fixed-left sidebar-mobile h-full justify-start max-sm:fixed max-sm:-translate-x-full">
          <section className="sidebar-title items-center p-4">
            ...
            <div className="flex flex-col">
              <span>Acme</span>
              <span className="text-content2 text-xs font-normal">Team Plan</span>
            </div>
          </section>
              ...
              <label className="whites hover:bg-gray-4 mx-2 flex h-fit w-full cursor-pointer p-0">
                <div className="flex flex-row gap-4 p-4">
                  <div className="avatar-square avatar avatar-md">
                    {user !== undefined ? <TextAvatar name={user.name ?? 'Demo User'} /> : null}
      ...
      <div className="flex w-full flex-col p-4">
        <div className="w-fit">
          <label htmlFor="sidebar-mobile-fixed" className="btn btn-primary sm:hidden">
            Open Sidebar
          </label>
        </div>

        <div className="my-4 grid grid-cols-2 gap-4">
          <div className="bg-gray-1 flex h-40 w-full items-center justify-center border-2 border-dashed border-border">+</div>
