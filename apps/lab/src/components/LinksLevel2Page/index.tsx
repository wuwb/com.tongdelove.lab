          ...
          const Links = item?.list?.map((link, index) => (
            <Fragment key={index}>
              <div className="d-flex flex-fill">
                <h4 className="text-gray mb-4 text-lg">
                  ...
                  <div key={index} className="url-card col-6 col-sm-6 col-md-4 col-xl-5a col-xxl-6a">
                    <div className="url-body default">
                      <a
                        ...
                        rel="noreferrer"
                        target="_blank"
                        className="group mb-4 block rounded border-0 bg-white shadow-md transition duration-300 ease-in-out"
                        style={{
                          boxShadow:
                            '0px 0px 20px -5px rgba(158, 158, 158, 0.2)',
                        }}
                      >
                        <div className="p-3">
                          <div className="flex items-center">
                            <div className="mr-2 flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden bg-black">
                            ...
                            <div className="url-info flex-fill">
                              ...
                              <p className="m-0 line-clamp-1 text-xs">
                                {link.description}
                              </p>
                            </div>
                          </div>
