...
export const LinksSidebar = () => {
  ...
  return (
    <div className="sticky sidebar-nav fade animate-nav w-[170px] border-r border-solid shrink-0">
        ...
        <div className="sidebar-logo border-bottom border-color">
          <div className="logo overflow-hidden">
            <a href="" className="logo-expanded">
              <img src="" height="40" className="logo-light"
                alt="" />
              <img src="" height="40" className="logo-dark d-none"
                alt="" />
            </a>
              ...
              categoryDate.map((category, index) => {
                ...
                return (
                  <Accordion.Item value={category.slug} key={index}>
                    <Accordion.Control className="px-2">{category.title}</Accordion.Control>
                    <Accordion.Panel>
                      {
