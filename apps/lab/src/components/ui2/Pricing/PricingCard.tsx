      ...
      <div className="dark:bg-scale-300 rounded-tl-[4px] rounded-tr-[4px] bg-white px-8 pt-6 ">
        <div className="mb-2 flex items-center gap-2">
          <div className="flex items-center gap-2">
            <h3 className="gradient-text-brand-500 dark:gradient-text-brand-100 flex items-center gap-4 font-mono text-2xl font-normal uppercase">Free</h3>
          </div>
        </div>
        <p className="text-scale-1100 dark:border-scale-500 my-4 h-[55px] border-b pb-4 text-sm lg:pr-20">Perfect for passion projects &amp; simple websites.</p>
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-end gap-2">
              <div>
                ...
                <p className="gradient-text-scale-500 dark:gradient-text-scale-100 mt-2 pb-1 text-5xl">$0</p>
                <p className="text-scale-900 mt-0.5 text-xs">per month per project</p>
                <p className="-mt-2">
                  <span className="bg-brand-500 text-brand-1100 rounded-md bg-opacity-30 px-2 py-0.5 text-xs ">Limit of 2 free projects</span>
                </p>
              </div>
            </div>
          </div>
