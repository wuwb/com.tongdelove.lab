...
function Solutions() {
  return (
    <div>
      <SectionHeading title="解决方案" subTitle="解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案" />
      <div className="mt-20 grid gap-20 lg:grid-cols-2">
        <div>
          <h3 className="font-fold mt-7 text-[32px]">强有力的工具</h3>
          <p className="mb-8 mt-4 text-gray-500">强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具</p>
          <ul className="grid gap-3">
            {[1, 2, 3].map(v => (
              <li className={`justify-between rounded border border-zinc-100 p-5 ${v === 1 && 'bg-zinc-100'}`} key={v}>
                ...
                <div className="relative flex justify-between">
                  ...
                  <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative -top-2 ml-8 shrink-0">
                    ...
                    />
                    <defs>
                      <filter id="filter0_d_0_125" x="0" y="0" width="38" height="38" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
