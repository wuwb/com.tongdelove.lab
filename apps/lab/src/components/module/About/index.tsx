...
const About = () => {
  ...
  return (
    <div id="about" className="container mx-auto px-4 py-12 sm:px-6 lg:px-12 xl:px-20">
      <div className="flex flex-col items-center justify-center">
        <div>
          <Image src={logo} alt={companyName} className="h-16 w-16" />
        </div>
        <div className="mt-4 flex h-12 flex-wrap items-center justify-center gap-8 sm:gap-10">
        ...
        <div className="mt-6 flex h-8 items-center gap-x-8">
          <a aria-label="github" href={socialMedia.github} target="_blank" rel="noreferrer">
            <svg className="fill-current text-gray-800 hover:text-primary dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
