...
import homeJsonEn from '@tongdelove/common-i18n/locales/en/demo.json' assert { type: 'json' };
import homeJsonFr from '@tongdelove/common-i18n/locales/fr/demo.json' assert { type: 'json' };
