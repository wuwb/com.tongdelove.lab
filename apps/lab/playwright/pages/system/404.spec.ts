...
import systemJsonEn from '@tongdelove/common-i18n/locales/en/system.json' assert { type: 'json' };
import systemJsonFr from '@tongdelove/common-i18n/locales/fr/system.json' assert { type: 'json' };
