...
import { selectState, setMouseUp, updateDesignData } from '@/models/workSlice'
...
const IndexPage = (props: Props) => {
  ...
  const transform = useCallback(
    (e) => {
      ...
      const offsetX = UnitConversion.pxConversionMm(
        e.clientX - mouseDownPosition.x
      )
      const offsetY = UnitConversion.pxConversionMm(
    ...
    [mouseDownElementStyle, mouseDownPosition, mouseMoveType]
  )
  ...
  const handleMouseMove = useCallback(
    ...
    [currentDesignData, isMouseDown, mouseMoveType, transform]
  )
