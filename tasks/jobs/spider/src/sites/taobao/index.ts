import { COOKIE_CLOUD_HOST, COOKIE_CLOUD_UUID, COOKIE_CLOUD_PASSWORD } from '../../constant'
import { cloud_cookie } from '../../cookie'
import axios from 'axios'

async function main() {
    const cookiesFromBrowser = await cloud_cookie(COOKIE_CLOUD_HOST, COOKIE_CLOUD_UUID, COOKIE_CLOUD_PASSWORD)
    ...
    const requestPath = 'https://s.taobao.com/search'
