...
import SidebarMenu from '@/components/layouts/components/AccentHeaderLayout/Sidebar/SidebarMenu';
import SidebarTopSection from '@/components/layouts/components/AccentHeaderLayout/Sidebar/SidebarTopSection';
...
export const TopNavigationLayout: FC<TopNavigationLayoutProps> = ({ children }) => {
