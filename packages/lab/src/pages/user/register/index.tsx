        ...
        <div className="g-6 flex h-full flex-wrap items-center justify-center text-gray-800">
          ...
          <div className="md:w-8/12 lg:ml-20 lg:w-5/12">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="form-group mb-6">
                ...
                <input
                  ...
                  type="text"
                  {...register('email')}
                  className={`form-control m-0 block w-full rounded border border-solid border-gray-300 bg-white bg-clip-padding px-4 py-2 text-xl font-normal text-gray-700 transition ease-in-out focus:border-blue-600 focus:bg-white focus:text-gray-700 focus:outline-none form-control ${errors.email ? 'is-invalid' : ''}`}
                />
              ...
              <Link href="/user/login" className="btn btn-link block mt-3">
            ...
            <div className="rounded-t-lg p-8">
              <p className="text-center text-sm text-gray-400 font-light">使用三方账号快速注册</p>
              <div>
