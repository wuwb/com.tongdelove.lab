...
import { base64Encode, hmacSHA1 } from '@/utils/crypto.util';
...
export class AliossService {
    ...
    async requestPolicy() {
        ...
        const isDev = this.configService.get('env') === this.configService.get('DEVELOPMENT');
        return {
            ...
            uploadData: {
                ...
                'x:callback-token': !isDev ? this.configService.get('aliyunOSS.callbackSecretToken') : undefined,
            },
