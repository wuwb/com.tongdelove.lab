...
import { AccessTokenInfo, AccessConfig, WechatError, WechatUserInfo } from './wechat-auth.interface';
...
export class WechatAuthService {
    ...
    async getUserByOpenid() {
        return await this.accountService.findAccountByOpenid(this.accessTokenInfo.openid);
    }
}
