...
import { RoleAccessEntity } from '@/modules/admin/system/role/entities/role-access.entity';
...
export class ApiAuthService {
  ...
  public async apiAuth(user: ICurrentUserType, method: string, url: string): Promise<boolean> {
    ...
    if (isSuper) {
      ...
      const authRoleIdList = authRoleList.map((item: AccountRoleEntity) => item.roleId);
