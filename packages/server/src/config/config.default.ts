...
const domain = 'dev.printlake.com';
const port = 3001;
const url = `http://${domain}`;
const mDomain = 'm-dev.printlake.com';
...
export const ConfigDefault = {
    ...
    static: {
        ...
        userLevelChapterURL: 'https://www.golang123.com/books/90/chapters/1515', // 用户等级在《如何使用社区》中的章节url
    },
    statsD: {
        host: 'localhost',
        port: 8125,
    ...
    weibo: {
        ...
        userInfoURL: 'https://api.weibo.com/2/user/show.json?access_token=%s&uid=%s',
    },
}
