...
export class OrganizationsService {
  private readonly logger = new Logger(OrganizationsService.name);
    ...
    public async create(createGithubOrganizationData: CreateOrganizationDto) {
        ...
        githubOrganization.public_members_url = createGithubOrganizationData.public_members_url;
        ...
        githubOrganization.has_organization_projects = createGithubOrganizationData.has_organization_projects;
        githubOrganization.has_repository_projects = createGithubOrganizationData.has_repository_projects;
