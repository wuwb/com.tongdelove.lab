import { Controller, Get, Injectable, Next, Param, Query, Res } from '@nestjs/common';
...
export class BookController {
    ...
    async booksView(@Param(':categoryPathname') categoryPathname: string, @Query('page') page: number, @Res() res, @Next() next): Promise<void> {
