import { DynamicModule, Module, Provider, Injectable } from '@nestjs/common';
// import { HttpKit, Kits, SIGN_TYPE } from '@/utls/';
import { WechatPayUtil } from './wechat-pay.util';
import { WX_API_TYPE, WX_DOMAIN } from './wechat-pay.constant';
