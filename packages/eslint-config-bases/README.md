# @tongdelove/eslint-config-bases
...
```bash
$ yarn add --dev eslint @tongdelove/eslint-config-bases
```
...
module.exports = {
  ...
  extends: [
    ...
    "@tongdelove/eslint-config-bases/react-query",
    "@tongdelove/eslint-config-bases/jest",
    "@tongdelove/eslint-config-bases/rtl",

    // "@tongdelove/eslint-config-bases/mdx",

    // "@tongdelove/eslint-config-bases/graphql-schema",
    // "@tongdelove/eslint-config-bases/storybook",
    // "@tongdelove/eslint-config-bases/playwright",
    ...
    // "@tongdelove/eslint-config-bases/prettier-config",
  ],
  rules: {
...
> **Tip:**
>
> - **Prettier**: `@tongdelove/eslint-config-bases/prettier-plugin` and `@tongdelove/eslint-config-bases/prettier-config` are
...
- `@tongdelove/eslint-config-bases/prettier-plugin` - eslint will run prettier under the hood
- `@tongdelove/eslint-config-bases/prettier-config` - eslint will just disable some conflicting rules (so you'll need to run prettier after)
...
```javascript
// @ts-check
const { getPrettierConfig } = require("@tongdelove/eslint-config-bases/helpers");
