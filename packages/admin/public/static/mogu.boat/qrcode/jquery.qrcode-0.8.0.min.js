  ...
  var t = function (r, t, e, n) {
    ...
    i = function (t, e, n) {
      ...
      var u = a.measureText(n.label).width,
        ...
        h = g + f,
        v = 0.01;
      1 === n.mode ? t.addBlank(0, g - v, o, h + v) : t.addBlank(c - v, g - v, s + v, h + v),
        (e.fillStyle = n.fontcolor),
        (e.font = i),
        e.fillText(n.label, c * o, g * o + 0.75 * n.mSize * o);
    },
    a = function (r, t, e) {
      var n = e.size,
        ...
        g = l + a,
        s = 0.01;
      3 === e.mode ? r.addBlank(0, l - s, n, g + s) : r.addBlank(f - s, l - s, c + s, g + s),
        t.drawImage(e.image, f * n, l * n, u * n, a * n);
    },
    u = function (t, e, n) {
      r(n.background).is('img')
        ? e.drawImage(n.background, 0, 0, n.size, n.size)
        : n.background && ((e.fillStyle = n.background), e.fillRect(n.left, n.top, n.size, n.size));
      var o = n.mode;
    ...
    g = function (r, t, e, n, o, i, a, u) {
      var f = r.isDark,
        ...
        D = f(a, w);
      T
        ? l(t, n, o, g, s, h, !p && !D, !p && !E, !A && !E, !A && !D)
        : c(t, n, o, g, s, h, p && D && y, p && E && B, A && E && k, A && D && M);
    },
    s = function (t, e, o) {
      var i,
        a,
      ...
      if (r(o.fill).is('img')) {
        ...
        (e.globalCompositeOperation = 'destination-out'),
          ...
          e.clip(),
          e.drawImage(o.fill, 0, 0, o.size, o.size),
          e.restore();
  ...
  var y = (function () {
    function r(t, e) {
      ...
      return (
        ...
        (o.mod = function (t) {
          ...
          for (
            var e = a.glog(o.get(0)) - a.glog(t.get(0)), n = new Array(o.getLength()), i = 0;
            i < o.getLength();
            i += 1
          )
            n[i] = o.get(i);
    ...
    var t = function (t, e) {
      var o = 236,
        ...
        M = function (r, t) {
          for (
            var e = -1, n = h - 1, o = 7, a = 0, u = i.getMaskFunction(t), f = h - 1;
            f > 0;
            f -= 2
          )
            for (6 == f && (f -= 1); ; ) {
        ...
        D = function (t, e) {
          for (
            var n = 0, o = 0, a = 0, u = new Array(e.length), f = new Array(e.length), l = 0;
            l < e.length;
            l += 1
          ) {
            var c = e[l].dataCount,
        ...
        C = function (r, t, e) {
          for (var n = u.getRSBlocks(r, t), l = f(), c = 0; c < e.length; c += 1) {
            var g = e[c];
            l.put(g.getMode(), 4),
              l.put(g.getLength(), i.getLengthInBits(g.getMode(), r)),
              g.write(l);
          }
              ...
              (s += 1),
                i.contains(h + v)
                  ...
                  : (g.write(i.indexOf(h), n),
                    i.size() < 4095 && (i.size() == 1 << n && (n += 1), i.add(h + v)),
                    (h = v));
            }
