...
(function () {
  ...
  c(h({ keywords: U, hashComments: true, cStyleComments: true, verbatimStrings: true, types: e }), [
    'cs',
  ]);
  c(h({ keywords: y, cStyleComments: true }), ['java']);
  c(h({ keywords: J, hashComments: true, multiLineStrings: true }), ['bash', 'bsh', 'csh', 'sh']);
  c(h({ keywords: K, hashComments: true, multiLineStrings: true, tripleQuotedStrings: true }), [
    'cv',
    'py',
    'python',
  ]);
  c(h({ keywords: s, hashComments: true, multiLineStrings: true, regexLiterals: 2 }), [
    'perl',
    'pl',
    'pm',
  ]);
  c(h({ keywords: g, hashComments: true, multiLineStrings: true, regexLiterals: true }), [
    'rb',
    'ruby',
  ]);
          ...
          if (!aD) {
            ...
            if (Z.test(aA.tagName)) {
              ...
              var aq = at
                ...
                ? az.getComputedStyle(aA, null).getPropertyValue('white-space')
                : 0;
