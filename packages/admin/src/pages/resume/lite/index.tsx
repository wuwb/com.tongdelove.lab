    ...
    <div className={styles.content}>
      <div>
        ...
        <ul className={styles['list']}>
          ...
          <li>
            <Space>
                博客 <a className="text-gray-500" href="https://blog.tongdelove.com/">
      ...
      <Title title="工作经历" subTitle="">
        ...
        >
          <ul>
            ...
            <li>1、基于 Midwayjs, Reactjs 开发报价系统，客户管理系统等运营系统。报价响应时间由十几分钟缩减至三五分钟，有效支撑业务发展。</li>
            <li>2、积累几千个客户，包括河南正大集团、澳门佳景集团等数家上市公司，江苏灰太狼食品，马来西亚 MamaVege 食品等数十家大型食品厂和连锁餐饮企业。与多家供应商、印刷厂、进出口公司建立合作关系。</li>
          </ul>
        </Item>
        <Item
        ...
        >
          <ul>
            <li>1、先后负责电商基础、导购支撑、广告流量、安全风控、会员账户等业务的前端研发工作。</li>
      ...
      <Title title="项目经历" subTitle="">
        ...
        >
          <ul>
            ...
            <li>
              1、项目两人在现有业务外抽调时间，在一个月内，快速修改商家IM，整合接入内网 IM。接入内网登录系统，开发不同消息类型的解析，消息加解密，本地存储搜索聊天记录，图片预览等功能。
            </li>
        ...
        <Item
          title="桂语应用上云项目" meta="2020.02 - 2020.04"
        >
          <ul>
            <li>描述：项目在于统一部署环境，降低运维成本，节约服务器资源。</li>
            <li>1、梳理前端 Nodejs 项目，定制部署规范，规划分配任务排期，统一上云。合并相关项目，精简服务器资源。</li>
            <li>2、优化 Nodejs 项目打包速度，从 10分钟以上优化到 5 分钟左右。</li>
          </ul>
        </Item>

        <Item
          title="VX Vue 代码转小程序工具项目" meta="2020.02 - 2020.03"
        >
          <ul>
            <li>描述：VX 转码工具用于转化 Vue 代码成小程序代码，复用代码，避免重复开发，降低维护成本。</li>
            <li>1、店铺线和逆向交易线等数十个项目接入，开发提效50%。</li>
          </ul>
        </Item>

        <Item
          title="Aides Vue 脚手架工具项目" meta="2017.11 - 2020.03"
        >
          <ul>
            <li>描述：项目用于支持 Vue 项目及组件的快速开发。</li>
            <li>1、同时支持应用和组件的开发，功能的插件化，支持自动页面路由，生成组件文档，发包前检测等功能。</li>
        ...
        <Item style={{pageBreakAfter: 'always'}}
          title="蘑菇街会员账户业务" meta="2018.06 - 2020.04"
        >
          <ul>
            <li>描述：会员账户业务主要涉及会员优惠权益等逻辑，意在拉新、维护和激活老客。</li>
            <li>1、负责会员中心、权益、账单、邀新送礼、任务中心、签到、个人中心、个人主页、注销等业务开发。</li>
            <li>2、开发会员业务测试平台，提供环境切换、账号切换、日期切换、签到状态设置、积分设置等功能。为业务开发测试节约大量时间。</li>
          </ul>
        </Item>

        <Item
          title="Xmen 后台搭建平台项目" meta="2016.04 - 2018.06"
        >
          <ul>
            <li>描述：XMEM 是一个前端代理服务，为内网后台系统提供前端模板渲染、数据请求转发及其登录权限、路由管理、静态资源发布等功能，意在简化后台前端的开发和管理。</li>
