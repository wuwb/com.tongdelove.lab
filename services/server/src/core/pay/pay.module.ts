...
import {
  WechatPayModuleAsyncOptions,
  WechatPayOptionsFactory,
} from './interface'
...
export class WechatPayModule {
  ...
  private static createAsyncOptionsProvider(
    options: WechatPayModuleAsyncOptions
  ): Provider {
    ...
    return {
      provide: WECHAT_PAY_MODULE_OPTIONS,
      useFactory: async (optionsFactory: WechatPayOptionsFactory) =>
        optionsFactory.createWechatPayOptions(),
