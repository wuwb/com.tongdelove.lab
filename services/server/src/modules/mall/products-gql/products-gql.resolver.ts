...
export class ProductsGqlResolver {
  ...
  createProductsGql(
    @Args('createProductsGqlInput')
    createProductsGqlInput: CreateProductsGqlInput
  ) {
  ...
  @Mutation(() => ProductsGql)
  updateProductsGql(
    @Args('updateProductsGqlInput')
    updateProductsGqlInput: UpdateProductsGqlInput
  ) {
    return this.productsGqlService.update(
      updateProductsGqlInput.id,
      updateProductsGqlInput
    )
  }
