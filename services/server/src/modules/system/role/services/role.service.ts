...
export class RoleService {
  ...
  async createRole(createRoleDto: CreateRoleDto) {
    ...
    // const findNameResult = await this.roleRepository.findOne({
    //   where: { name },
    //   select: ['id'],
    // })
    // if (findNameResult) {
   ...
   * 根据角色 id 删除角色
   */
  async destroyRoleById(id: string) {
  ...
  // 根据角色 id 修改角色
  async modifyRoleById(id: string, updateRoleDto: UpdateRoleDto) {
  ...
  // 查询角色列表
  async roleList(roleReqDto: RoleReqDto) {
    // const {
