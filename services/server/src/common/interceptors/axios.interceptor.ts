...
const v2exHttpInstance = axios.create({
...
createInterceptor(v2exHttpInstance)
export const $v2exHttp = v2exHttpInstance
...
createInterceptor(defaultInstance)
export const $defaultHttp = defaultInstance
