...
import {
  ...
  ECommentState,
  ESortType,
} from '@/shared/interfaces/state.interface'
...
export interface IQueryParamsResult {
  querys: any // 用于 paginate 的查询参数
  options: any // 用于 paginate 的查询配置参数
  params: any // 路由参数
  origin: any // 原味的 querys 参数
...
export type TTransformConfig = EQueryParamsField | string | any
