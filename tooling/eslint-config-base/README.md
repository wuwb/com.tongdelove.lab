...
```bash
$ yarn add --dev eslint @tongdelove/eslint-config-base
```
...
require("@tongdelove/eslint-config-base/patch/modern-module-resolution");
...
module.exports = {
  ...
  extends: [
    ...
    "@tongdelove/eslint-config-base/react-query",
    "@tongdelove/eslint-config-base/jest",
    "@tongdelove/eslint-config-base/rtl",

    // "@tongdelove/eslint-config-base/mdx",

    // "@tongdelove/eslint-config-base/graphql-schema",
    // "@tongdelove/eslint-config-base/storybook",
    // "@tongdelove/eslint-config-base/playwright",
    ...
    // "@tongdelove/eslint-config-base/prettier-config",
  ],
  rules: {
...
> **Tip:**
>
> - **Prettier**: `@tongdelove/eslint-config-base/prettier-plugin` and `@tongdelove/eslint-config-base/prettier-config` are
...
- `@tongdelove/eslint-config-base/prettier-plugin` - eslint will run prettier under the hood
- `@tongdelove/eslint-config-base/prettier-config` - eslint will just disable some conflicting rules (so you'll need to run prettier after)
...
```javascript
// @ts-check
const { getPrettierConfig } = require("@tongdelove/eslint-config-base/helpers");
